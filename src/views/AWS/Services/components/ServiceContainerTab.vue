          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-2">
              ...
              <div>
                ...
                <CardDescription class="text-xs">Resources and Environment Variables
                </CardDescription>
              </div>
            </div>
          </div>
          ...
          <Tabs default-value="container-0">
            ...
            >
              ...
              <div class="grid grid-cols-12 gap-4">
                ...
                <CustomWidget class="col-span-3" title="CPU" :value="container.cpu ?? 'N/A'"
                              :icon="CpuIcon">
                </CustomWidget>
              </div>
                    ...
                    <CardHeader class="py-3">
                      <div class="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <CardDescription class="text-xs">Configuration and Secrets
                          </CardDescription>
                        </div>
                      </div>
                    </CardHeader>
