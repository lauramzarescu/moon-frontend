...
<template>
    <div>
        ...
        <div class="mt-6 flex justify-between">
            <Button variant="outline" @click="updateStep(Math.max(1, currentStep - 1))" :disabled="currentStep === 1"> Previous </Button>
            <Button @click="updateStep(Math.min(steps.length, currentStep + 1))" :disabled="currentStep === steps.length">
