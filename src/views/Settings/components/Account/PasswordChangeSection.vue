...
const confirmWithTwoFactor = async () => {
  ...
  try {
    ...
    await userService.changePasswordWith2FA(
...
<template>
  <div>
    ...
    <Alert v-if="isSamlUser" variant="warning" class="mb-4">
      ...
      <AlertDescription>
        Password change and two-factor authentication are disabled for SAML users.
        Please contact your organization administrator to manage your authentication settings.
      </AlertDescription>
    </Alert>
    ...
    <div class="flex items-center justify-between space-y-4">
      ...
      <Button variant="outline" @click="showPasswordModal = true" :disabled="isSamlUser">
        Change Password
      </Button>
    </div>
          ...
          >
            ...
            <DialogFooter>
              ...
              <Button
                type="submit"
                :disabled="isLoading"
                @keydown.enter="onPasswordSubmit(formValues)"
              >
        ...
        <div v-if="step === 2" class="space-y-6">
          <div class="text-sm text-center">
            ...
            <p class="text-muted-foreground">
              For security reasons, please enter the current 6-digit code from your authenticator
              app
