...
const userRoleDisplay = computed(() => {
  ...
  return authStore.user.role.charAt(0).toUpperCase() +
    authStore.user.role.slice(1).toLowerCase()
})
  ...
  <div class="flex items-center gap-2">
    ...
    <Button :disabled="true" variant="ghost" size="icon" class="relative">
      ...
      <span v-if="hasNotifications"
            class="absolute top-1 right-1 h-2 w-2 rounded-full bg-red-500"></span>
      <!--      <span-->
